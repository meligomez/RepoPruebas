...
//			{
//				MessageBox.Show("Sus puntos no son suficientes para el premio.", "¡Oops!. No se pudo realizar el canje.",
...
//				p.actualizarPuntaje(userLogueado.cliente.Id_Cliente, premio.puntos, premio.Id,int.Parse(lblPuntosVigentes.Text));
